...
let a = localStorage.getItem("searchitem");
let searchitem = "";
if (a) {
  searchitem = a;
}
...
const searchbtn = document.getElementsByClassName("nav2-2")[0];
searchbtn.addEventListener("click", (event) => {
  event.preventDefault();
  const searchbar = document.getElementsByClassName("serchbar")[0];
  const b = searchbar.value;
  localStorage.setItem("searchitem", b);
